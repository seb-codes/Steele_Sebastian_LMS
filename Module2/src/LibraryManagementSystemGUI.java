            ...
            public void actionPerformed(ActionEvent e) {
                ...
                switch (choice) {
                    ...
                    case 3: String output = librarySystem.getLibraryBooksAsString();
                        JOptionPane.showMessageDialog(frame, output, "Library Books", JOptionPane.PLAIN_MESSAGE);
                        break;
                    case 4 : String[] availableTitles = librarySystem.getLibraryBookTitles();
                        ...
                        if (availableTitles.length==0) {
                            ...
                            JComboBox<String> titleComboBox = new JComboBox<>(availableTitles);
                            JPanel titlePanel = new JPanel();
                        ...
                        break;
                    case 5 : String[] availableTitlesOut = librarySystem.getLibraryBookTitlesOut();

                        if (availableTitlesOut.length==0) {
                            JOptionPane.showMessageDialog(frame, "No available books to check in.", "Check Out a Book", JOptionPane.INFORMATION_MESSAGE);
                        } else {
                            JComboBox<String> titleComboBox = new JComboBox<>(availableTitlesOut);
                            JPanel titlePanel = new JPanel();
                            titlePanel.add(new JLabel("Select a book to check in:"));
                            titlePanel.add(titleComboBox);

                            int result = JOptionPane.showConfirmDialog(frame, titlePanel, "Check IN a Book", JOptionPane.OK_CANCEL_OPTION, JOptionPane.QUESTION_MESSAGE);
